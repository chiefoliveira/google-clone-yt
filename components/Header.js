...
function Header() {
    ...
    return (
        <header className="sticky top-0 bg-white">
            ...
            <Image 
            src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png" height={40} width={120} 
            ...
            <Avatar className="ml-auto" url="https://t.ctcdn.com.br/P7-_JvQTS4U7-if6zHyXjyMiNQ8=/400x400/smart/i606944.png" />
            </div>
